  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <?php /* ?><form action="<?php echo Yii::app()->createUrl('/user/login'); ?>" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Email" name="UserLogin[username]" id="UserLogin_username"/>
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Password" name="UserLogin[password]" id="UserLogin_password"/>
        ...
        */?>
        <?php echo $content ?>
        <a href="<?php echo Yii::app()->createUrl('user/recovery') ?>">Lupa Kata Laluan</a><br>
        <a href="<?php echo Yii::app()->createUrl('user/registration') ?>" class="text-center">Pendaftaran Ibu Bapa</a>
