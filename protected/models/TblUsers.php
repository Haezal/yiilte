 ...
 * @property BranchTeachers[] $branchTeachers
...
class TblUsers extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'branchManagers' => array(self::HAS_MANY, 'BranchManagers', 'user_id'),
			'branchOwners' => array(self::HAS_MANY, 'BranchOwners', 'user_id'),
			'branchTeachers' => array(self::HAS_MANY, 'BranchTeachers', 'user_id'),
