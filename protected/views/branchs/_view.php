<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('gmaps')); ?>:</b>
	<?php echo CHtml::encode($data->gmaps); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('latlong')); ?>:</b>
	<?php echo CHtml::encode($data->latlong); ?>
	<br />
